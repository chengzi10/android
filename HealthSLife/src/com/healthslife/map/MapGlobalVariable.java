...
public class MapGlobalVariable {
	...
	protected static LatLng Polyline = null; // 定义坐标对象
	...
	protected static List<LatLng> points_LatLng_Polyline = new ArrayList<LatLng>();
	protected static boolean isMapFirstLoc = true;  
	protected static int i = 0;// record the LatLng's location
}
