...
public class ServiceGlobalVariable {

	public static String updataUserInfoResult = null;  //set the result of update user info
	public static String updataUserDataResult = null;
